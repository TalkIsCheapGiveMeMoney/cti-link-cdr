...
import com.tinet.ctilink.cdr.runnable.InvestigationWorker;
 ...
 */
@Component
public class InvestigationService extends Thread {
    ...
    public void run() {
        ...
        while (!shutdown) {
            try {
                List<JSONObject> dataList = investigationMessageQueue.receiveMessage(JSONObject.class);
                //一次取出多条
