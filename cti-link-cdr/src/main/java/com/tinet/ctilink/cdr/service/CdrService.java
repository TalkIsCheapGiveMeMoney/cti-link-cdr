...
import com.tinet.ctilink.cdr.runnable.Worker;
 ...
 */
@Component
public class CdrService extends Thread {
    ...
    public void run() {
        ...
        while (!shutdown) {
            try {
                List<JSONObject> dataList = cdrMessageQueue.receiveMessage(JSONObject.class);
                //一次取出多条
